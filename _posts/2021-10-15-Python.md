...
[`--enables-shared`](https://docs.python.org/3/using/configure.html#linker-options) is important for external programs calling Python methods and APIs on the binary level.
...
[A simple demonstration](https://docs.python-guide.org/dev/virtualenvs/#installing-packages-for-your-project).

### Dependency Manager: Poetry

[Poetry](https://python-poetry.org/docs/) is a better dependency manager. I should use `poetry` over `pipenv` if possible.
